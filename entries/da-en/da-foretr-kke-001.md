...
inflections:
  ...
  present: foretrækker
  past: foretræktrak
  past_participle: foretræktrukket
...
```
phonetic_plain: FORETREHKKE
ipa: /ˈfɔrəˌtrɛkə/
syllables: fo-re-træk-ke
stoed: TODO
```
...
```yaml
examples:
  - danish: Jeg ville foretrække en kat frem for en hund.
    english: I would rather have a cat than a dog.
    source: tatoeba
    source_id: 516118
```
