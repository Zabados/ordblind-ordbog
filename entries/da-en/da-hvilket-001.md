...
```
primary_translation: which; that; what (neuter relative pronoun)
...
```yaml
examples:
  - danish: Af dem var 1084 positive, hvilket svarer til 1,35 procent af prøverne.
    english: SKIP
    source: leipzig
    source_id: SKIP
```
