...
```
phonetic_plain: NURDVENDEE
ipa: [nøðˈʋɛnˀd̥i]
syllables: nød-ven-dig
stoed: TODO
```
...
```
primary_translation: necessary, essential
...
```yaml
examples:
  - danish: Ingen forudgående erfaring er nødvendig.
    english: No prior experience is necessary.
    source: tatoeba
    source_id: 5364378
```
