...
```
primary_translation: to act (to do something)
...
```yaml
examples:
  - danish: Vi må handle hurtigt.
    english: We must act quickly.
    source: tatoeba
    source_id: 4912811
