...
```
primary_translation: to contain
secondary_translations:
  - to harbor or grasp (feelings, thoughts)
```
...
```yaml
examples:
  - danish: Bussen kan rumme halvtreds personer.
    english: The bus takes fifty people.
    source: tatoeba
    source_id: 8101784
```
