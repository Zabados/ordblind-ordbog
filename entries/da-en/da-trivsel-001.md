...
```
inflections:
  indefinite_singular: trivsel
  definite_singular: trivslen eller (uofficielt) -en
...
```
primary_translation: well-being
...
```yaml
examples:
  - danish: Et mindre fald i elevernes trivsel.
    english: A minor decrease in student well-being.
    source: leipzig
    source_id: SKIP
```
