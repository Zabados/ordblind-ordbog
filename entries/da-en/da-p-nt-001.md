...
```
primary_translation: fairly, pretty; to some extent
...
```yaml
examples:
  - danish: Det er ikke pænt at pege.
    english: It is bad manners to point at people.
    source: tatoeba
    source_id: 8137663
  - danish: Han fandt mig et pænt slips.
