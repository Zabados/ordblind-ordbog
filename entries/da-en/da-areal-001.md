...
```
inflections:
  indefinite_singular: areal
  definite_singular: arealet
  indefinite_plural: arealer
  definite_plural: arealerne
```
...
```
primary_translation: area, space
...
```yaml
examples:
  - danish: Så meget areal nytter noget.
    english: So much space is useful.
    source: leipzig
    source_id: SKIP
```
