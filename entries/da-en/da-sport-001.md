...
```
inflections:
  indefinite_singular: sport
  definite_singular: sporten
...
```yaml
examples:
  - danish: Kan hun lide sport?
    english: Does she like sports?
    source: tatoeba
    source_id: 7588790
  - danish: Fodbold er en sport.
    english: Soccer is a sport.
    source: tatoeba
    source_id: 10672831
  - danish: Football er en sport.
