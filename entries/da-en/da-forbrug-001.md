...
```
inflections:
  indefinite_singular: forbrug
  definite_singular: forbruget
...
```
primary_translation: consumption; expenditure; use
...
```yaml
examples:
  - danish: Japan har et stort forbrug af papir.
    english: Japan consumes a lot of paper.
    source: tatoeba
    source_id: 4562313
```
