...
inflections:
  infinitive: bidrage
  present: bidrager
  past: bidrog (eller -de)
  past_participle: bidraget
...
```
primary_translation: to contribute
...
```yaml
examples:
  - danish: Den bedste måde at hjælpe os er ved at bidrage på dit eget modersmål.
    english: The best way to help us is to contribute in your own native language.
    source: tatoeba
    source_id: 3594578
```
