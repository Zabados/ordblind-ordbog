...
```
inflections:
  indefinite_singular: politi
  definite_singular: politiet
...
```yaml
examples:
  - danish: Hjælp! Politi! Hjælp!
    english: Help! Police! Help!
    source: tatoeba
    source_id: 12423169
  - danish: Det algeriske politi arresterede ham for ulovligt at krydse grænsen.
    english: The Algerian police arrested him for illegally crossing the border.
    source: tatoeba
    source_id: 8133192
```
