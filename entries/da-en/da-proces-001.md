...
```
inflections:
  indefinite_singular: proces
  definite_singular: processen
  indefinite_plural: processer
  definite_plural: processerne
```
...
```yaml
examples:
  - danish: Det er en vanskelig proces.
    english: It's a difficult process.
    source: tatoeba
    source_id: 8518686
```
