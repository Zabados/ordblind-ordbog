...
```yaml
examples:
  - danish: Adskillige borgere var i dag mødt op for at blive testet.
    english: SKIP
    source: leipzig
    source_id: SKIP
```
