...
inflections:
  positive: mobile
  neuter: mobilen eller -t
  plural_definite: mobiler
  comparative: TODO
  superlative: TODO
```
...
```yaml
examples:
  - danish: Hvorfor eksisterer der ikke en version af Tatoeba for mobile enheder?
    english: Why is there no mobile version of Tatoeba?
    source: tatoeba
    source_id: 2507559
```
