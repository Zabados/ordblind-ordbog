...
```
phonetic_plain: HISTORISK
ipa: TODO
syllables: hi-sto-risk
stoed: TODO
```
...
```yaml
examples:
  - danish: Dette er et historisk øjeblik.
    english: This is an historical moment.
    source: tatoeba
    source_id: 5139970
