...
```
primary_translation: return, reciprocation
...
```yaml
examples:
  - danish: Denne tabletcomputer har en lav vægt, men til gengæld en høj pris.
    english: This tablet is low weight but high price.
    source: tatoeba
    source_id: 8183893
```
