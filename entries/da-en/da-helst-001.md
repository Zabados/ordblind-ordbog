...
```
primary_translation: preferably; most of all; by preference
...
```yaml
examples:
  - danish: Spørg hvem som helst.
    english: Ask anybody.
    source: tatoeba
    source_id: 4170791
  - danish: Hvem som helst kan gøre det.
