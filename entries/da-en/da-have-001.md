...
```
inflections:
  indefinite_singular: have
  definite_singular: haven
  indefinite_plural: haver
  definite_plural: haverne
```
...
```yaml
examples:
  - danish: Aalborg Stift skal have ny domprovst.
    english: SKIP
    source: leipzig
    source_id: SKIP
```
