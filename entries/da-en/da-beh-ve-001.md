...
```yaml
examples:
  - danish: Hun behøver hjælp.
    english: She needs help.
    source: tatoeba
    source_id: 2885671
  - danish: Jeg behøver dem ikke.
    english: "I don't need them."
    source: tatoeba
    source_id: 10728725
```
