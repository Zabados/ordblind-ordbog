...
```
inflections:
  indefinite_singular: institution
  definite_singular: institutionen
  indefinite_plural: institutioner
  definite_plural: institutionerne
```
...
```
primary_translation: institution
...
```yaml
examples:
  - danish: Og i institutioner.
    english: And in institutions.
    source: leipzig
    source_id: SKIP
```
