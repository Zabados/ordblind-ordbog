...
```
primary_translation: perhaps, possibly, maybe
...
```yaml
examples:
  - danish: Måske har du ret.
    english: Perhaps you're right.
    source: tatoeba
    source_id: 9766448
  - danish: Måske vinder Tom.
    english: Maybe Tom will win.
    source: tatoeba
    source_id: 6116661
