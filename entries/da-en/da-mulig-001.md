...
```
primary_translation: possible, feasible
...
```yaml
examples:
  - danish: Er en kolonisering af Mars mulig?
    english: Is a colonisation of Mars possible?
    source: tatoeba
    source_id: 10531330
