...
```
inflections:
  infinitive: acceptere
  present: accepterer
  past: accepterede
  past_participle: accepteret
...
```
phonetic_plain: ACCEPTERE
ipa: TODO
syllables: ac-cep-te-re
stoed: TODO
```
...
```
primary_translation: to accept
secondary_translations:
  - to recognize, validate, verify
```
...
```yaml
examples:
  - danish: Jeg kan ikke acceptere din undskyldning.
    english: I do not accept your excuse.
    source: tatoeba
    source_id: 4442353
