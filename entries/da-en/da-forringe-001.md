...
```
phonetic_plain: FORRINYE
ipa: TODO
syllables: for-rin-ge
stoed: TODO
```
...
```
primary_translation: to make worse; to deteriorate, diminish, degrade
...
```yaml
examples:
  - danish: FOA frygter, at kvaliteten forringes.
    english: FOA fears that the quality will deteriorate.
    source: leipzig
    source_id: SKIP
```
