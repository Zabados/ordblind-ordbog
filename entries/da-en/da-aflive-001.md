...
```
primary_translation: to euthanize
...
```yaml
examples:
  - danish: Min dyrlæge rådede mig til at lade min hund aflive.
    english: My vet recommended putting my dog to sleep.
    source: tatoeba
    source_id: 8052128
```
