...
```
primary_translation: to celebrate
...
```yaml
examples:
  - danish: Har vi noget at fejre?
    english: Do we have something to celebrate?
    source: tatoeba
    source_id: 10702460
  - danish: Lad være at fejre det for tidligt.
    english: Don't celebrate too early.
    source: tatoeba
    source_id: 8592846
```
