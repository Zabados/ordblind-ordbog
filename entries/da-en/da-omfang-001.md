...
```
inflections:
  indefinite_singular: omfang
  definite_singular: omfanget
...
```
primary_translation: extent, scope, size, range, reach, volume, circumference, girth
...
```yaml
examples:
  - danish: Stort i omfang og i indhold.
    english: Large in scope and in content.
    source: leipzig
    source_id: SKIP
```
