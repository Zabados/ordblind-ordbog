...
```
primary_translation: forced to; obliged
...
```yaml
examples:
  - danish: Jeg er nødt til at gå.
    english: I have to go.
    source: tatoeba
    source_id: 1998522
  - danish: I er nødt til at vente.
    english: You have to wait.
    source: tatoeba
    source_id: 10696017
