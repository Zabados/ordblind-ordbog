...
```
primary_translation: between, between them
...
```yaml
examples:
  - danish: Det sker en gang imellem.
    english: That happens sometimes.
    source: tatoeba
    source_id: 7452231
  - danish: Ja det sker en gang imellem.
    english: Yes, it happens from time to time.
    source: tatoeba
    source_id: 1856921
