...
```
primary_translation: to go around, travel
...
```yaml
examples:
  - danish: "Mennesker færdes ikke her.\""
    english: "People don't move around here.\""
    source: leipzig
    source_id: SKIP
```
