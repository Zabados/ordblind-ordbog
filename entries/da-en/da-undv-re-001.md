...
```
primary_translation: to do without, miss
...
```yaml
examples:
  - danish: Tom kan undværes.
    english: Tom is expendable.
    source: tatoeba
    source_id: 4633002
```
