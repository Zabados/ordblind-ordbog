...
```
primary_translation: to want to, be willing to
...
```yaml
examples:
  - danish: Alex kender mange i Haslev, som gerne ville lykønske ham.
    english: SKIP
    source: leipzig
    source_id: SKIP
```
