...
```
inflections:
  indefinite_singular: kapacitet
  definite_singular: kapaciteten
  indefinite_plural: kapaciteter
  definite_plural: kapaciteterne
```
...
```
phonetic_plain: KAPACITET
ipa: TODO
syllables: ka-pa-ci-tet
stoed: TODO
```
...
```yaml
examples:
  - danish: Så vi har god kapacitet.
    english: So we have good capacity.
    source: leipzig
    source_id: SKIP
```
