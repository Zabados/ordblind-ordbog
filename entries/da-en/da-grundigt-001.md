...
```
primary_translation: thorough; careful; methodical
...
```yaml
examples:
  - danish: Jeg lover at læse rapporten grundigt.
    english: I promise to read the report carefully.
    source: tatoeba
    source_id: 12970853
```
