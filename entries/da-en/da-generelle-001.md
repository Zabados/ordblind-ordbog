...
```
phonetic_plain: YENERELLE
ipa: TODO
syllables: ge-ne-rel-le
stoed: TODO
```
...
```yaml
examples:
  - danish: Så de generelle retningslinjer gælder.
    english: So the general guidelines apply.
    source: leipzig
    source_id: SKIP
```
