...
```
primary_translation: homeless (lacking a permanent residence)
...
```yaml
examples:
  - danish: Er du hjemløs?
    english: Are you homeless?
    source: tatoeba
    source_id: 12409140
  - danish: Han er hjemløs.
    english: He is homeless.
    source: tatoeba
    source_id: 10710516
