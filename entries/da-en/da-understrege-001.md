...
```
inflections:
  infinitive: understrege
  present: understreger
  past: understregede
  past_participle: understreget
...
```
phonetic_plain: UNDERSTREYE
ipa: TODO
syllables: un-der-stre-ge
stoed: TODO
```
...
```
primary_translation: to underline
...
```yaml
examples:
  - danish: Det faktum bør du understrege.
